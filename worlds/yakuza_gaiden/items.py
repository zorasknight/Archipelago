...
AKAME_FETCH_MINIMUMS = {
    "Bento Lunch Set": 1,
    "Healthy Balanced Bento": 1,
    "Luxury Yakiniku Bento": 2,
    "Pork Tonkatsu Bento": 1,
    "Oden": 1,
    "Pine Candy": 1,
    "SEGA Taiyaki": 1,
    "Taiyaki Ice Cream": 1,
    "Sushi Set": 1,
    "Okonomiyaki": 1,
    "Okonomiyaki (Mentai Mayo)": 1,
    "Okonomiyaki (Mochi & Cheese)": 1,
    "Takoyaki with Large Octopus": 1,
    "Shockin' Takoyaki": 1,
    "Chu-Chu Tako Doll (Takoyaki)": 1,
    "Kitty Kat (Tiger)": 1,
    "Tauriner": 1,
    "Tauriner Maximum": 1,
    "Azuki Bar BOX": 1,
    ...
    "Ichiban Senbei (Shoyu)": 1,
    "Ichiban Fried Senbei": 1,
