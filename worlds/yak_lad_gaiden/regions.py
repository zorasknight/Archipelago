...
def create_and_connect_regions(world: YakLadGaidenWorld) -> None:
    create_all_regions(world)
    connect_regions(world)


def create_all_regions(world: YakLadGaidenWorld) -> None:
...
def connect_regions(world: YakLadGaidenWorld) -> None:
