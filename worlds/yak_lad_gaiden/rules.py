...
def set_all_rules(world: YakLadGaidenWorld) -> None:
...
def set_all_entrance_rules(world: YakLadGaidenWorld) -> None:
    ...
    world.set_rule(sotenbori_to_sotenbori_akame_3, button_pressed)
    ...
    if world.options.hammer:
        ...
        world.set_rule(colosseum_to_pocket_circuit, can_smash_brick)
    ...
    world.set_rule(sotenbori_akame_3_to_colosseum, lambda state: state.has("Key", world.player))
    ...
    world.set_rule(sotenbori_akame_3_to_colosseum, HAS_KEY)
...
def set_all_location_rules(world: YakLadGaidenWorld) -> None:
...
def set_completion_condition(world: YakLadGaidenWorld) -> None:
